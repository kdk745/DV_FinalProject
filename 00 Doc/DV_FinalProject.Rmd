...
##Methodology
We followed the methodology learned in class to analyze our data and product interesting visualizations, the most fascinating of which we put into a Shiny App.
...
1. 
![](../02 Tableau/Treemap total deaths.jpg)

##Treemap: Deaths by Cause
![](../02 Tableau/Treemap Deaths by Cause.jpg)
...
6. Change the dropdown under Marks to "Line."
![](../02 Tableau/MexicoUS Scatterplot.jpg)
...
5. On the Dimensions Tab, click ont he menu, and select "Create Parameter." Name it "KPI Low."
